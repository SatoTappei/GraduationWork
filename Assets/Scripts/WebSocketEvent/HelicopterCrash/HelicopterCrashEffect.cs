...
namespace Game
{
    public class HelicopterCrashEffect : MonoBehaviour
    {
        ...
        IEnumerator PlayAsync(Vector2Int targetCoords)
        {
            ...
            _helicopterParent.position = GetRandomPosition(transform.position);
            _missileParent.position = GetRandomPosition(transform.position);
            ...
            yield return _waitExplosion ??= new WaitForSeconds(1.5f);
        ...
        static Vector3 GetRandomPosition(Vector3 center)
        {
