...
namespace Game
{
    public class WebSocketEventExecutor : MonoBehaviour
    {
        void Start()
        {
        ...
        void OnGUI()
        {
            ...
            {
                if (TryGetComponent(out RevelationEvent sendInformation))
                {
            ...
            {
                if (TryGetComponent(out PowerUpEvent powerUp))
                {
                    powerUp.Execute();
                }
            }
            ...
            {
                AdventurerSpawner spawner = AdventurerSpawner.Find();
